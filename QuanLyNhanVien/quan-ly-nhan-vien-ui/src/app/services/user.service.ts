...
export class UserService {
  ...
  public getCurrentUser(): LoggedInUser | null {
    return this.currentUserSubject.value;
  }

  public getToken(): string | null {
    return this.currentUserSubject.value?.token || localStorage.getItem('jwtToken');
  }
  ...
  isAdmin(): boolean {
    ...
    return user ? user.roles.some(r => r === 'Admin') : false;
  }
